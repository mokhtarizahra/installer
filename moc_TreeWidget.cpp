...
#include <memory>
#include "Module/TreeWidget/TreeWidget.h"
...
QT_MOC_LITERAL(3, 25, 8), // "itemText"
QT_MOC_LITERAL(4, 34, 30), // "updateTreeWidgetFromMainWindow"
QT_MOC_LITERAL(5, 65, 7), // "modules"
QT_MOC_LITERAL(6, 73, 8), // "nextItem"
QT_MOC_LITERAL(7, 82, 12) // "previousItem"

    },
    "TreeWidget\0itemSelected\0\0itemText\0"
    "updateTreeWidgetFromMainWindow\0modules\0"
    "nextItem\0previousItem"
};
...
void TreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateTreeWidgetFromMainWindow((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TreeWidget::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TreeWidget::itemSelected(QString _t1)
{
