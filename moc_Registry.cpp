...
#include <memory>
#include "Module/Registry/Registry.h"
...
QT_INIT_METAOBJECT const QMetaObject Registry::staticMetaObject = { {
    QMetaObject::SuperData::link<Designer::staticMetaObject>(),
    qt_meta_stringdata_Registry.data,
    qt_meta_data_Registry,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Registry::qt_metacast(const char *_clname)
{
    ...
    return Designer::qt_metacast(_clname);
}

int Registry::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Designer::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
